...
//200是樱花数量，2.0是樱花大小
  ...
  <div class="collapse navbar-collapse" id="navmenu">
    <ul class="navbar-nav mr-auto nav">	 
      <li class="nav-item">
        <a class="nav-link" href="index.php">留言首页</a>
      </li>
	  <!--<li class="nav-item">
	  ...
	  <?php if(ADMIN){
        ...
        <a class="nav-link" id="logout" href="javascript:;">安全退出</a>
      </li>';
	  }else{
	  echo '<li class="nav-item">
        <a class="nav-link" href="#login" data-toggle="tab">管理登录</a>
      </li>';
		  }?>
    </ul>
	   <div class="my-2"></div>
...
<div class="form-group">
<textarea class="form-control" rows="5" id="content" placeholder="留下想说的话*"></textarea>
</div>
...
?>      
  ...
  ?>
   ...
   <!-- </div>-->  
<footer class="p-5 text-center">Powered by <a href="/" target="_blank">MR.WANG</a> </footer>   
<!--对话框-->
<!-- 模态框 -->
...
<script src="https://myhkw.cn/api/player/1663642898106" id="myhk" key="1663642898106" m="1">//播放器</script> 
